    ...
    <StyledTwitterCard>
      <CardBody>
        ...
        <Para>
          ...
          <Value fontSize='1.1rem'>Completed</Value>
        </Para>
        <Para>
          <Block>
          ...
          <Value fontSize='1.1rem'>Dex Listing Completed</Value>
        </Para>
        <Para>
          <Block>
          ...
          <Value fontSize='1.1rem'>7 Days Left</Value>
        </Para>
        <Para>
          <Block>
          ...
          <Value fontSize='1.1rem'>Locked with RugDoc Liquidity Lock</Value>
        </Para>
